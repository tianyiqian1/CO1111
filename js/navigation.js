...
async function populateHeader() {
    ...
    if( PAGE_STATE=='quiz' ) {
        ...
        bt_score=`<a hidden class='app_navi quiz_navi' href='javascript:showLeaderboardEvent()'>Leaderboard</a>`;
    }

    // assemble

    header.innerHTML = bt_home + bt_reload + bt_stop + bt_name; // + bt_score;
